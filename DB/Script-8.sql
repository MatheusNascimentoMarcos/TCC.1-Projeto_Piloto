...
{ CALL `Staging Area`.GetDates() }



use olist;
INSERT INTO olist.DM_Cliente (ID_Cliente_Exclusivo, CEP, Cidade, UF, Data_Inicio, Data_Fim, Ativo)
SELECT ID_Cliente_Exclusivo, CEP, Cidade, UF, Data_Inicio, Data_Fim, Ativo
FROM 'Staging Area'.DM_Cliente_Load;



-- `Staging Area`.DM_Cliente_Load definition
use teste;
CREATE TABLE `DM_Cliente_Load` (
  `ID_Cliente_Exclusivo` varchar(200) NOT NULL,
